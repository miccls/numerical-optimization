...
\begin{Def}[Weak local minimizer]
    ...
    \footnote{
        ...
        For more on Euclidean topology, s] \href{https://en.wikipedia.org/wiki/Real_coordinate_space\#Topological_properties}{\textcolor{blue}{here}}.
} 
% -------------------------------------------------------
...
Assuming a unit step size, the relation betw]n subsequent steps is 
\[
x_{k+1} = x_k + p
\]
