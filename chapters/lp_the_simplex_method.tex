...
\begin{enumerate}
    \item Does convexity of a problem imply that the KKT conditions are sufficient?
          ...
          \begin{Def}[Convex problem]
            Given the functions $c_i, i \in \mathcal{I}$, $c_j, j \in \mathcal{E}$ and $f$, in the problem \eqref{eq:constrained-problem}, we say that the optimization problem is \textit{convex} if
            \begin{align*}
